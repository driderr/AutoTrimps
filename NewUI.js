...
createSetting('challenge', 'Challenge', 'Challenge to run on portal', 'dropdown', 'Nom', ['None', 'Balance', 'Electricity', 'Crushed', 'Nom', 'Toxicity', 'Watch', 'Lead']);
...
createSetting('CoordinationAbandon', 'Coordination Abandon', 'Abandon the army if a new army is available and we have a coordination that has not been updated in our attack numbers yet.', 'boolean', false);
saveSettings();
updateValueFields();
